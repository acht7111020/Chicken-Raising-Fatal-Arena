...
#line 15 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\MPU6050.c"
...
#line 16 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\MPU6050.c"
...
#line 17 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\MPU6050.c"
#line 18 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\MPU6050.c"
#line 19 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\MPU6050.c"
...
#line 20 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\MPU6050.c"
...
#line 21 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\MPU6050.c"

void MPU6050_WriteByte(uint8_t MPU6050_reg, uint8_t MPU6050_data)
{
	uint8_t data[1];
	   data[0]=MPU6050_data;
     I2C_writeBytes(((I2C_T *) (((uint32_t)0x40100000) + 0x20000)), 0xD0, MPU6050_reg, 1, data);
}

uint8_t MPU6050_ReadByte(uint8_t MPU6050_reg)
{
	uint8_t data[1];
     I2C_readBytes(((I2C_T *) (((uint32_t)0x40100000) + 0x20000)), 0xD0, MPU6050_reg, 1, data);	
	   return (data[0]);
}
...
int16_t Read_MPU6050_AccX(void)
{
	...
	LoByte = MPU6050_ReadByte(0x3C); 
	HiByte = MPU6050_ReadByte(0x3B); 
...
{
	uint8_t LoByte, HiByte;
	LoByte = MPU6050_ReadByte(0x3E); 
	HiByte = MPU6050_ReadByte(0x3D); 
	return ((HiByte<<8) | LoByte);
}
...
{
	uint8_t LoByte, HiByte;
	LoByte = MPU6050_ReadByte(0x40); 
	HiByte = MPU6050_ReadByte(0x3F); 
	return ((HiByte<<8) | LoByte);
}
...
{
	uint8_t LoByte, HiByte;
	LoByte = MPU6050_ReadByte(0x44); 
	HiByte = MPU6050_ReadByte(0x43); 
	return ((HiByte<<8) | LoByte);
}
...
{
	uint8_t LoByte, HiByte;
	LoByte = MPU6050_ReadByte(0x46); 
	HiByte = MPU6050_ReadByte(0x45); 
	return ((HiByte<<8) | LoByte);
}
...
{
	uint8_t LoByte, HiByte;
	LoByte = MPU6050_ReadByte(0x48); 
	HiByte = MPU6050_ReadByte(0x47); 
	return ((HiByte<<8) | LoByte);
}

uint16_t Read_MPU6050_ID(void)
{
