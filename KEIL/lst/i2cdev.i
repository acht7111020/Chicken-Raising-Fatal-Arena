#line 1 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\I2Cdev.c"
...
#line 5 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\I2Cdev.c"
...
#line 6 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\I2Cdev.c"
...
#line 7 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\I2Cdev.c"

void I2C_readBytes(I2C_T *i2c, uint8_t devAddr, uint8_t regAddr, uint8_t length, uint8_t *data) 
{
	uint8_t i, tmp;
	      ( (i2c)->CON = ((i2c)->CON & ~(0x1ul << (4))) | (0x1ul << (3)) );                         
	      do { while(!((i2c)->INTSTS & (0x1ul << (0)))); (i2c)->INTSTS |= (0x1ul << (0)); } while(0);
	
	      ( (i2c)->DATA = devAddr );         
	      ( (i2c)->CON = ((i2c)->CON & ~0x1e) | 0x10 );
	      do { while(!((i2c)->INTSTS & (0x1ul << (0)))); (i2c)->INTSTS |= (0x1ul << (0)); } while(0);
	      ...
	      ( (i2c)->CON = ((i2c)->CON & ~0x1e) | 0x08 | 0x10 );	
	      do { while(!((i2c)->INTSTS & (0x1ul << (0)))); (i2c)->INTSTS |= (0x1ul << (0)); } while(0);
	      ...
	      do { while(!((i2c)->INTSTS & (0x1ul << (0)))); (i2c)->INTSTS |= (0x1ul << (0)); } while(0);							
				...
				do { (i2c)->CON |= ((0x1ul << (4)) | (0x1ul << (2))); while((i2c)->CON & (0x1ul << (2))); } while(0);										 
}
