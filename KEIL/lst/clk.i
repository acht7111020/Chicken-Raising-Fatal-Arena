...
void CLK_DisableCKO1(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APBCLK &= (~(0x1ul << (7)));
}
...
void CLK_EnableCKO0(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->FRQDIV0 = (0x1ul << (4)) | u32ClkDiv | u32ClkDivBy1En<<(5);
...
void CLK_EnableCKO1(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (~(0x3ul << (0)))) | u32ClkSrc;

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->FRQDIV1 = (0x1ul << (4)) | u32ClkDiv | u32ClkDivBy1En<<(5);
...
uint32_t CLK_GetPCLKFreq(void)
{
    ...
    uint32_t PCLK_Div;
    PCLK_Div = ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APB_DIV & (0x7ul << (0));
    SystemCoreClockUpdate();
...
uint32_t CLK_GetPLLClockFreq(void)
{
    ...
    if (u32PllReg & ((uint32_t)(0x00020000))) {
        if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL & (0x1ul << (12)))
...
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    CLK_SetHCLK((2UL<<(0)),(((1-1)<< (0)) & (0xful << (0))));
    return SystemCoreClock;
}
...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if ( u32PllFreq < 16000000)
        u32PllFreq=16000000;
    else if(u32PllFreq > 32000000)
        u32PllFreq=32000000;

    if(u32PllClkSrc == ((uint32_t)(0x00000000))) {
         
        ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL &= ~((uint32_t)(0x00020000));
        u32PllCr = (12000000UL);
    } else {
         
        ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL |= ((uint32_t)(0x00020000));
        if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1ul << (12)))
            u32PllCr =(16000000UL);
        else
            u32PllCr =(12000000UL);
    }
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL = ( ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL & ~((0x3ful << (0)) | (0xful << (8)) ) )| u32PLLReg;
