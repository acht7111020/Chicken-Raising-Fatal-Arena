...
void SYS_Init(void)
{
    ...
    CLK_EnableXtalRC((0 | (0x1ul << (1)) | (0x1ul << (2)) | 0));    
    CLK_WaitClockReady((0 | (0x1ul << (1)) | (0x1ul << (4)) | 0));	
    CLK_SetCoreClock(32000000);      
       ...
       CLK_EnableModuleClock(((1UL<<31)|(1<<29)|(7<<25) |( 8<<20)|(1<<18)|(0xF<<10) |( 8<<5)|(2) ));	
#line 38 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
			 CLK_SetModuleClock(((1UL<<31)|(1<<29)|(7<<25) |( 8<<20)|(1<<18)|(0xF<<10) |( 8<<5)|(2) ), (0x2UL<<(8)), (((2-1)<< (8)) & (0xful << (8))));
#line 50 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
	

       CLK_EnableModuleClock(((1UL<<31)|(1<<29)|(7<<25) |(12<<20)|(1<<18)|(0xF<<10) |(12<<5)|(3) ));	
#line 66 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
			 CLK_SetModuleClock(((1UL<<31)|(1<<29)|(7<<25) |(12<<20)|(1<<18)|(0xF<<10) |(12<<5)|(3) ), (0x4UL<<(12)),(((1-1)<< (12)) & (0xful << (12))));
...
#line 94 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 116 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
		

		   CLK_EnableModuleClock(((1UL<<31)|(1<<29)|(7<<25) |(19<<20)|(0<<18)|(0xFF<<10) |(16<<5)|(28) ));
#line 129 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
       CLK_SetModuleClock(((1UL<<31)|(1<<29)|(7<<25) |(19<<20)|(0<<18)|(0xFF<<10) |(16<<5)|(28) ), (0x3UL<<(19)),(((1-1)<< (16)) & (0xfful << (16))));
    ...
    CLK_EnableModuleClock(((1UL<<31)|(0<<29)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(9) ));		
	  CLK_SetModuleClock(((1UL<<31)|(0<<29)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(9) ), 0, 0);

 
#line 156 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
			CLK_EnableModuleClock(((1UL<<31)|(1<<29)|(3<<25) |( 4<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(20)));


#line 169 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
			CLK_EnableModuleClock(((1UL<<31)|(1<<29)|(3<<25) |( 6<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(21)));

		
#line 187 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 203 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 213 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 223 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 239 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
		
#line 255 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
...
#line 281 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PA_L_MFP = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PA_L_MFP & ~(0xful << (16))) | (2UL<<(16));
#line 293 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
    ((GPIO_T *) (((uint32_t)0x50000000) + 0x04000))->OFFD = ((GPIO_T *) (((uint32_t)0x50000000) + 0x04000))->OFFD | ((0 | 0 | 0 | 0 | (1UL << 4) | 0 | 0 | 0)<< 16);


#line 302 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 323 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
		
#line 332 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
		 ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PC_H_MFP = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PC_H_MFP & ~(0xful << (8))) | (5UL<<(8));


		 ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PC_H_MFP = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PC_H_MFP & ~(0xful << (12))) | (5UL<<(12));
#line 347 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
		
#line 371 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
     ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PD_H_MFP = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PD_H_MFP & ~(0xful << (4)))  | (3UL<<(4));



#line 395 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
		
#line 416 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 428 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 443 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 458 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 473 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 497 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 521 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
		
#line 539 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 557 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"

#line 575 "..\\..\\..\\..\\Library\\NuMakerLib\\Source\\SYS_init.c"
